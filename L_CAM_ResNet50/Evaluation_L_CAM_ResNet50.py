...
for idx, dat  in tqdm(enumerate(val_loader)):  
   ...
   # cam_map = model.get_c([0])
    ...
    # #cam_map = torch.sigmoid(cam_map)
    #cam_map = F.interpolate(cam_map, size=(224,224))
 #   cam_map = torch.sigmoid(cam_map)
...
#    cam_map2 = cam_map2[0,0,:,:]
#    cam_map2 = cam_map2.cpu().data.numpy()
#    plt.imshow(cam_map2)
#    plt.axis('off')    
#    plt.show()
    #savefig(str(idx)+'_resnet_wo_sigmoid.png', bbox_inches='tight', pad_inches=0)
