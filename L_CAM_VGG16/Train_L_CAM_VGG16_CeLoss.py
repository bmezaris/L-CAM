...
from utils.Restore import restore
from models import VGG16_L_CAM_FmA, VGG16_L_CAM_ImgA
...
Snapshot_dir = os.path.join(ROOT_DIR,'snapshots', 'ResNet50_Att_CS_sigmoidSaliency_fmXsal_CL_BiasTrue')
...
def get_arguments():
    ...
    parser.add_argument("--arch", type=str,default='ResNet50_Att_CS_sigmoidSaliency_fmXsal_CL')
