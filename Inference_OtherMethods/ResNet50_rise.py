...
wrapped_model = RISE(model, (224, 224))
# Create masks -Run this once to create masks
wrapped_model.generate_masks(N=8000, s=7, p1=0.5, savepath='RiseResNet50_8000_7x7.npy')
wrapped_model.load_masks('RiseResNet50_8000_7x7.npy',p1=0.5)
...
for idx, dat  in tqdm(enumerate(val_loader)):
    ...
    cam_map = wrapped_model(img_n.cuda())
    cam_map = cam_map[index_gt_y]
    cam_map = torch.unsqueeze(cam_map, 0)
